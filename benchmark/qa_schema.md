...
| `manual_transcription_flag`  | boolean  | `true` if any gold block comes from a hand-transcribed table (see [docs/corpus_notes.md](#docs/corpus_notes.md) for the six affected papers).  |
